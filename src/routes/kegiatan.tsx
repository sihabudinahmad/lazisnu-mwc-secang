...
function KegiatanPage() {
  ...
  const isDetailPage = pathname !== "/kegiatan";
  ...
  return (
    <>
      <PageHeader
        ...
        title="Kegiatan Amal & Sosial 2025–2026"
              ...
              <div className="p-5">
                ...
                <div className="mt-4">
                  <Link
                    to="/kegiatan/$slug"
                    params={{ slug: k.slug }}
                    className="inline-flex items-center rounded-md bg-primary px-3 py-2 text-xs font-semibold text-primary-foreground transition-colors hover:bg-primary/90"
                  >
                    Lihat Detail Galeri
                  </Link>
                </div>

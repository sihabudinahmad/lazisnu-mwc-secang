...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Laporan tahunan UPZISNU CARE LAZISNU MWC NU Secang 2024: kegiatan, keuangan koin donasi, dan layanan ambulance se-Kecamatan Secang." },
      { name: "author", content: "LAZISNU MWC NU Secang" },
      { property: "og:title", content: "LAZISNU MWC Secang — Annual Report 2024" },
      { property: "og:description", content: "Laporan tahunan resmi LAZISNU MWC NU Kecamatan Secang." },
